...
print("-------------(More Options)-------------")
print("\n")
print("xx.- use all methods with one url")
...
if selection == '1':
    ...
    print("https://discord.com/api/webhooks/1279256648703148042/dx5beLkoT0Zq0YBI1prOhIb8rZ2VLHAaHx9aO-0s3MC-r71ZeNogtQm65Kgz9ICPkKys")
elif selection == 'xx':
